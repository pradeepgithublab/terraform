...
resource "aws_sns_topic" "topic" {          
  ...
  lambda_success_feedback_role_arn = "arn:aws:iam::582088112675:role/Lambda_role_234010.65091671"          
  lambda_failure_feedback_role_arn  ="arn:aws:iam::582088112675:role/Lambda_role_234010.65091671"          
}			
...
resource "aws_lambda_function" "lambda" {           
  ...
  role          = "arn:aws:iam::582088112675:role/Lambda_role_234010.65091671"         
